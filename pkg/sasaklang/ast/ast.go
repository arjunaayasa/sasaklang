...
type LetStatement struct {
	Token token.Token // the token.GAWE token
	Name  *Identifier
	Value Expression
}
...
type ConstStatement struct {
	Token token.Token // the token.TETEP token
	Name  *Identifier
	Value Expression
}
...
type BreakStatement struct {
	Token token.Token // the 'tipuq' token
}
...
type ContinueStatement struct {
	Token token.Token // the 'lanjut' token
}
...
type FunctionLiteral struct {
	...
	Body       *BlockStatement
	Name       string // optional name for named functions
}
...
// IndexExpression represents an array/map indexing
